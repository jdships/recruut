...
import { exportCsvApplicationListSchema } from "~/schemas/applications/export-csv-application-list-schema";
...
export async function POST(req: NextRequest): Promise<NextResponse> {
	...
	const bodyParsingResult = exportCsvApplicationListSchema.safeParse(body);
	...
	const filename = "application-list.csv";
